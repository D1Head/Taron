...
let LogService = class LogService {
    ...
    constructor(logRepo) {
        ...
        this.createLogs = (data) => __awaiter(this, void 0, void 0, function* () {
            return {};
        });
        this.updateLogs = (id, data) => __awaiter(this, void 0, void 0, function* () {
            return {};
        });
        this.getLogs = () => __awaiter(this, void 0, void 0, function* () {
            return {};
        });
        this.getLogsById = (id) => __awaiter(this, void 0, void 0, function* () {
            return {};
        });
    }
};
